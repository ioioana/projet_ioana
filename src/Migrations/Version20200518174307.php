 ...
 */
final class Version20200518174307 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE services_packages (service_id INT NOT NULL, package_id INT NOT NULL, INDEX IDX_B8855CD3ED5CA9E6 (service_id), INDEX IDX_B8855CD3F44CABFF (package_id), PRIMARY KEY(service_id, package_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
