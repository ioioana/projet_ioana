...
//            dump($package);
//            dump($package->services);
//            dump($package);
//            $theServices=$package->getServices()->getValues();
            $theServices=$package->getServices();
//            dump($theServices);
//            exit();
...
//        dump($theServices);
//        dump($this);
//        dump($package->getServices());
//        dump($package->getServices()->getValues());
//        dump($package->getServices()->unwrap());
//        dump($package->getServices()->unwrap()->toArray());
//        exit();
